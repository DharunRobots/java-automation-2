...
public class Chatbot extends JFrame implements KeyListener {
	...
	String[][] chatBot = {
			// standard greetings
			{ "hi", "hello", "hola", "ola", "howdy" }, { "hi what you want me to call you" },
			// question greetings

			{ "how are you", "how r you", "how r u", "how are u" }, { "good", "doing well" },
			// introduce
			{ "i'm", "my name" }, { "OK, it's my pleasure" },
			// default
			{ "shut up", "you're bad", "noob", "stop talking", "(the ChatBot is unavailable, due to LOL)" }, };
